...
namespace Catch {
    ...
    void EventListenerBase::testCasePartialStarting(TestCaseInfo const&, std::uint64_t) {}
    void EventListenerBase::sectionStarting( SectionInfo const& ) {}
    void EventListenerBase::sectionEnded( SectionStats const& ) {}
    void EventListenerBase::testCasePartialEnded(TestCaseStats const&, std::uint64_t) {}
